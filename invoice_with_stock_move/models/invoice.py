...
class Purchase(models.Model):
    ...
    def _prepare_invoice(self):
        result = super(Purchase, self)._prepare_invoice()
        result.update({
...
class AccountMove(models.Model):
    ...
    create_stock_moves = fields.Boolean("Create Stock Moves?",default=True, copy=False, states=STATES)
        ...
        for line in self.invoice_line_ids:
            if line.product_id and line.product_id.type!='service':
                StockMoveL.with_context(default_immediate_transfer=True).create({
                    ...
                    'lot_id': line.batch_no and line.batch_no.id or False, 
                    'lot_name': line.batch_no and line.batch_no.name or '', 
